...
<div class="col-md-12">
	...
	<div ng-app="sa_app" ng-controller="controller" ng-init="show_data()">
		<div class="col-md-6">
		   	<label>Name</label>
            <input type="text" name="name" ng-model="name" class="form-control" required placeholder="plz enter your name">
            <br/>
            <label>Email</label>
            <input type="email" name="email" ng-model="email" class="form-control" required placeholder="plz enter proper email address">
            <br/>
            <label>Age</label>
            <input type="number" name="age" ng-model="age" class="form-control" required placeholder="plz enter your age">
            <br/>
